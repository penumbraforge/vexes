...
Welcome to the in-repository reference for the experimental vexes dependency
scanner.

These in-repository files are the documentation version reviewed with this
source tree. An external GitHub wiki or website, if published, must be synced
separately and is not the release artifact.

## Pages

- **[Getting Started](Getting-Started.md)** -- Installation, first scan, understanding output
- **[Commands Reference](Commands-Reference.md)** -- Usage and options for scan, analyze, fix, guard, monitor, inspect, doctor, licenses, and explain
